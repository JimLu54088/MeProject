...
public class Constants {
    ...
    //yyyyMMdd
    public static final SimpleDateFormat dateFormatYYYYMMDD = new SimpleDateFormat("yyyyMMdd");

    //yyyyMMddHHmmss
    public static final SimpleDateFormat dateFormatYYYYMMDDHHMMSS = new SimpleDateFormat("yyyyMMddHHmmss");
